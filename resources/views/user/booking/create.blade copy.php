                    ...
                    <form class="form-card p-4" action="{{ route('user.getSession') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                ...
                                <label class="btn btn-outline-primary" for="btncheck1">Lapak 1</label>
                              
                                <input type="checkbox" class="btn-check" id="btncheck2" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btncheck2">Lapak 2</label>
                              
                                <input type="checkbox" class="btn-check" id="btncheck3" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btncheck3">Lapak 3</label>
                              </div>
                        </div>
